...
- [clang 6+](https://clang.llvm.org/)
  ...
  - Windows:
    ...
    Visual Studio 2019 ships with LLVM (see the Visual Studio section). However,
...
- [Visual Studio 2019 or higher](https://visualstudio.microsoft.com/)
  ...
  choco install -y visualstudio2019community --package-parameters "add
...
configuration. If you run into difficulty using them, please refer to their
