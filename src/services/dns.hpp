...
ENABLE_REFLECTION_FOR(opencmw::service::dns::Context, contextType, protocol, hostname, port, service_name, service_type,
...
ENABLE_REFLECTION_FOR(opencmw::service::dns::QueryResponse, protocol, hostname, port, service_name, service_type,
        signal_name, signal_unit, signal_rate, signal_type)
ENABLE_REFLECTION_FOR(opencmw::service::dns::QueryEntry, protocol, hostname, port, service_name, service_type,
        signal_name, signal_unit, signal_rate, signal_type);
