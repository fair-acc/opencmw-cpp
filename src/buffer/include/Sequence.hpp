#ifndef OPENCMW_SEQUENCE_HPP
#define OPENCMW_SEQUENCE_HPP
...
template<>
struct fmt::formatter<opencmw::buffer::Sequence> {
    ...
    auto format(opencmw::buffer::Sequence const& value, FormatContext& ctx) const {
