...
template<opencmw::buffer::WaitStrategyLike auto wait = opencmw::buffer::NoWaitStrategy()>
struct TestStruct {
...
using CircularBufferSingle = opencmw::buffer::CircularBuffer<int32_t, std::dynamic_extent, opencmw::buffer::ProducerType::Single>;
using CircularBufferMulti  = opencmw::buffer::CircularBuffer<int32_t, std::dynamic_extent, opencmw::buffer::ProducerType::Multi>;
...
TEST_CASE("Buffer:basicConcepts", "[Buffer]") {
    auto circularBufferTest = []<typename T> {
