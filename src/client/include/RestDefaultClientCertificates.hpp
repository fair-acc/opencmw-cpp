#ifndef OPENCMW_CPP_RESTDEFAULTCLIENTCERTIFICATE_HPP
...
/** @brief: Bundle of root certificates for SSL/TLS connections
 * N.B. The certificate origin is as indicated and has been split to fit the <65k string-literal limit
 */
...
#endif // OPENCMW_CPP_RESTDEFAULTCLIENTCERTIFICATE_HPP
