...
TEST_CASE("Long polling example", "[http2]") {
...

    {
        ...
        unsub.topic           = URI<>(fmt::format("http://localhost:{}/foo?param1=1&param2=foo%2fbar", kServerPort));
        ...
        get.topic           = URI<>(fmt::format("http://localhost:{}/foo?param1=1&param2=foo%2fbar", kServerPort));
