...
ExternalProject_Add(Nghttp3Project
        ...
        GIT_TAG 067568a14caa2384944ba78cfd796990d2d6f07d  # TODO update to release after 32caf8c9 (> v1.9.0)
        GIT_SHALLOW ON
...
ExternalProject_Add(NgTcp2Project
        ...
        BUILD_BYPRODUCTS ${CMAKE_BINARY_DIR}/ngtcp2-install/lib/libngtcp2.a ${CMAKE_BINARY_DIR}/ngtcp2-install/lib/libngtcp2_crypto_ossl.a
        CMAKE_ARGS
...
set_target_properties(ngtcp2-crypto-ossl-static PROPERTIES
        IMPORTED_LOCATION "${CMAKE_BINARY_DIR}/ngtcp2-install/lib/libngtcp2_crypto_ossl.a"
        INTERFACE_INCLUDE_DIRECTORIES "${CMAKE_BINARY_DIR}/ngtcp2-install/include"
)
